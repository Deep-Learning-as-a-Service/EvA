...
class KirillAlexDeepConvLSTM(RainbowModel):
    ...
    def _create_model(self):
        ...
        conv_layer = lambda the_input: Conv2D(64, kernel_size=(5, 1), activation="relu", kernel_initializer=initializer)(the_input)
        lstm_layer = lambda the_input: LSTM(n_units_lstm, dropout=0.5, return_sequences=True, kernel_initializer=initializer)(the_input)
