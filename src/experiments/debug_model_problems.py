...
load_recordings = lambda: load_dataset(os.path.join("data/opportunity-dataset-csv", 'data.csv'), 
...
problematic_SeqEvoGenome = get_problematic_genome()
SeqEvoModelChecker.check_model_genome(problematic_SeqEvoGenome)
model_genome = SeqEvoModelGenome.create_with_default_params(problematic_SeqEvoGenome)