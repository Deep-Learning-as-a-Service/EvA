...
# thanks to kirill for this function :)
def load_pamap2_dataset(
    ...
    for subject_id in subject_ids:
        ...
        file_path = os.path.join(settings.pamap2_dataset_path, file_name)
        ...
        recordings.append(Recording(
            ...
            activities=df.loc[:, "activity_id"].map(lambda label: settings.pamap2_initial_num_to_activity_idx[label]),
            subject=subject_id,
